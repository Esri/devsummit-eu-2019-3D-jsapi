require([
  ...
  var pointsOfInterest = new GeoJSONLayer({
    ...poiProperties,
    definitionExpression: "OBJECTID NOT IN (7, 8, 9)"
  });
  ...
  var splineRoute = new SplineLayerProxy({
    lineLayer: new GeoJSONLayer({
      ...routeProperties,
      // definitionExpression: "OBJECTID NOT IN (6, 7)",
    })
  });
  ...
  var cam1 = {"position":{"spatialReference":{"latestWkid":3857,"wkid":102100},"x":2834227.263116874,"y":4407959.1320211515,"z":10259.69266181998},"heading":71.47186925713666,"tilt":68.4540696168012};
  var cam2 = {"position":{"spatialReference":{"latestWkid":3857,"wkid":102100},"x":2909267.7261782526,"y":4399088.846807993,"z":16805.999082318507},"heading":298.35003357447044,"tilt":63.85292898850031};
  var cam3 = {"position":{"spatialReference":{"latestWkid":3857,"wkid":102100},"x":2883697.5705055334,"y":4403069.620041345,"z":6904.628980355337},"heading":351.5768300688249,"tilt":55.967438524588125};
  ...
  view.when().then(function() {
    ...
    var steps = [
      ...
      function() {
        pointsOfInterest.definitionExpression = "OBJECTID NOT IN (7, 8, 9)";
